    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center">
        <div class="w-full max-w-lg rounded-[36px] bg-white/80 backdrop-blur shadow-xl ring-1 ring-[#F7C8B8]/60 p-10">
            ...
            <div class="text-center mb-8">
                <h2 class="text-2xl font-semibold text-[#7C3A2D]">Lupa Kata Sandi?</h2>
            ...
            {{-- STATUS MESSAGE --}}
            @if (session('status'))
                <div class="mb-4 rounded-xl bg-green-100 border border-green-200 px-4 py-3 text-sm text-green-800">
                    {{ session('status') }}
                </div>
            @endif
