        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center w-full">
            ...
            <div class="w-full max-w-lg rounded-[36px] bg-[#FAF8F1] border border-[#822021] shadow-xl shadow-[#822021]/10 p-10">
                ...
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-[#822021]">Atur Kata Sandi Baru</h2>
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                    ...
                    {{-- PASSWORD BARU --}}
                    <div class="space-y-2">
                        <label class="text-sm font-bold text-[#822021]">Kata Sandi Baru</label>
                    ...
                    {{-- KONFIRMASI PASSWORD --}}
                    <div class="space-y-2">
                        <label class="text-sm font-bold text-[#822021]">Konfirmasi Kata Sandi</label>
