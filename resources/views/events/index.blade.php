...
<x-layouts.app :title="'Event & Workshop'">
    ...
    {{-- SECTION HERO & SEARCH --}}
    <section class="relative overflow-hidden bg-[#FFDEF8] pb-10 pt-16">
        {{-- Dekorasi Background --}}
    ...
    {{-- HASIL PENCARIAN --}}
    <section class="min-h-[500px] bg-[#FFDEF8]">
                        ...
                        <div class="p-6 flex flex-col flex-grow text-left"> <div class="h-16 mb-4 flex items-center">
                            ...
                            <div class="space-y-3 mb-6">
                                ...
                                <div class="flex items-center gap-3 text-[#822021] font-['Poppins']">
                                    ...
                                    <span class="text-sm font-medium">{{ $event->remainingSlots() ?? 'Tidak terbatas' }} peserta</span>
                                </div>
                            </div>
